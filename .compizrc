...
s0_launcher_reveal_edge_timeout = 300
...
[core]
s0_active_plugins = core;bailer;detection;composite;opengl;compiztoolbox;decor;annotate;gnomecompat;vpswitch;staticswitcher;place;grid;commands;regex;text;obs;move;session;imgpng;mousepoll;resize;snap;wall;animation;fade;expo;workarounds;scale;unityshell;
...
s0_mode_matches = 
s0_mode_modes = 
s0_viewport_matches = class=Pidgin;class=Skype;class=Eclipse;class=Google-chrome;class=RSSOwl;class=Empathy;;
s0_viewport_x_values = 2;2;1;1;2;2;1;
s0_viewport_y_values = 2;2;1;2;1;2;1;
